...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_BULBASAUR]   = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 16 },
    [SPECIES_IVYSAUR]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_VENUSAUR]    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_CHARMANDER]  = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 13 },
    [SPECIES_CHARMELEON]  = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_CHARIZARD]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_SQUIRTLE]    = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 12 },
    [SPECIES_WARTORTLE]   = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_BLASTOISE]   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_CATERPIE]    = { .size = MON_COORDS_SIZE(40, 32), .y_offset = 16 },
    [SPECIES_METAPOD]     = { .size = MON_COORDS_SIZE(40, 32), .y_offset = 20 },
    [SPECIES_BUTTERFREE]  = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_WEEDLE]      = { .size = MON_COORDS_SIZE(40, 32), .y_offset = 17 },
    [SPECIES_KAKUNA]      = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 14 },
    [SPECIES_BEEDRILL]    = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_PIDGEY]      = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 13 },
    [SPECIES_PIDGEOTTO]   = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
    [SPECIES_PIDGEOT]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_RATTATA]     = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 14 },
    [SPECIES_RATICATE]    = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 11 },
    [SPECIES_SPEAROW]     = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 12 },
    [SPECIES_FEAROW]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_EKANS]       = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 15 },
    [SPECIES_ARBOK]       = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
    [SPECIES_PIKACHU]     = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  9 },
    [SPECIES_RAICHU]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_SANDSHREW]   = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 11 },
    [SPECIES_SANDSLASH]   = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_NIDORAN_F]   = { .size = MON_COORDS_SIZE(40, 32), .y_offset = 16 },
    [SPECIES_NIDORINA]    = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_NIDOQUEEN]   = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_NIDORAN_M]   = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 12 },
    [SPECIES_NIDORINO]    = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_NIDOKING]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_CLEFAIRY]    = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 16 },
    [SPECIES_CLEFABLE]    = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
    [SPECIES_VULPIX]      = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 12 },
    [SPECIES_NINETALES]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_JIGGLYPUFF]  = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 16 },
    [SPECIES_WIGGLYTUFF]  = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  8 },
    [SPECIES_ZUBAT]       = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 13 },
    [SPECIES_GOLBAT]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_ODDISH]      = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 12 },
    [SPECIES_GLOOM]       = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_VILEPLUME]   = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    [SPECIES_PARAS]       = { .size = MON_COORDS_SIZE(48, 32), .y_offset = 18 },
    [SPECIES_PARASECT]    = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    [SPECIES_VENONAT]     = { .size = MON_COORDS_SIZE(40, 56), .y_offset = 11 },
    [SPECIES_VENOMOTH]    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    [SPECIES_DIGLETT]     = { .size = MON_COORDS_SIZE(40, 32), .y_offset = 17 },
    [SPECIES_DUGTRIO]     = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 12 },
    [SPECIES_MEOWTH]      = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 12 },
    [SPECIES_PERSIAN]     = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    [SPECIES_PSYDUCK]     = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  9 },
    [SPECIES_GOLDUCK]     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_MANKEY]      = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 14 },
    [SPECIES_PRIMEAPE]    = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_GROWLITHE]   = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 12 },
    [SPECIES_ARCANINE]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_POLIWAG]     = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 16 },
    [SPECIES_POLIWHIRL]   = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 11 },
    [SPECIES_POLIWRATH]   = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  7 },
    [SPECIES_ABRA]        = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_KADABRA]     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_ALAKAZAM]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_MACHOP]      = { .size = MON_COORDS_SIZE(32, 48), .y_offset = 11 },
    [SPECIES_MACHOKE]     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_MACHAMP]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_BELLSPROUT]  = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 15 },
    [SPECIES_WEEPINBELL]  = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_VICTREEBEL]  = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  5 },
    [SPECIES_TENTACOOL]   = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_TENTACRUEL]  = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  1 },
    [SPECIES_GEODUDE]     = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 18 },
    [SPECIES_GRAVELER]    = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_GOLEM]       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_PONYTA]      = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
    [SPECIES_RAPIDASH]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_SLOWPOKE]    = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 13 },
    [SPECIES_SLOWBRO]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_MAGNEMITE]   = { .size = MON_COORDS_SIZE(40, 24), .y_offset = 22 },
    [SPECIES_MAGNETON]    = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 16 },
    [SPECIES_FARFETCHD]   = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 11 },
    [SPECIES_DODUO]       = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
    [SPECIES_DODRIO]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_SEEL]        = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_DEWGONG]     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_GRIMER]      = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_MUK]         = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_SHELLDER]    = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 16 },
    [SPECIES_CLOYSTER]    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_GASTLY]      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_HAUNTER]     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_GENGAR]      = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_ONIX]        = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
    [SPECIES_DROWZEE]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  9 },
    [SPECIES_HYPNO]       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_KRABBY]      = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 14 },
    ...
    [SPECIES_EXEGGCUTE]   = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_EXEGGUTOR]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_CUBONE]      = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 13 },
    [SPECIES_MAROWAK]     = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 13 },
    [SPECIES_HITMONLEE]   = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  4 },
    [SPECIES_HITMONCHAN]  = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  4 },
    [SPECIES_LICKITUNG]   = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    [SPECIES_KOFFING]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_WEEZING]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    ...
    [SPECIES_TANGELA]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_KANGASKHAN]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_HORSEA]      = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 16 },
    [SPECIES_SEADRA]      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_GOLDEEN]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_SEAKING]     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  4 },
    [SPECIES_STARYU]      = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 13 },
    [SPECIES_STARMIE]     = { .size = MON_COORDS_SIZE(48, 56), .y_offset = 10 },
    [SPECIES_MR_MIME]     = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    [SPECIES_SCYTHER]     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_JYNX]        = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    ...
    [SPECIES_ARTICUNO]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_ZAPDOS]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_MOLTRES]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_DRATINI]     = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    ...
    [SPECIES_MEW]         = { .size = MON_COORDS_SIZE(56, 56), .y_offset = 13 },
    ...
    [SPECIES_TEDDIURSA]   = { .size = MON_COORDS_SIZE(32, 48), .y_offset = 11 },
