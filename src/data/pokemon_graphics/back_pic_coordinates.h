...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_IVYSAUR]     = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    [SPECIES_VENUSAUR]    = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_CHARMANDER]  = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 12 },
    [SPECIES_CHARMELEON]  = { .size = MON_COORDS_SIZE(56, 56), .y_offset = 9  },
    [SPECIES_CHARIZARD]   = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 4  },
    [SPECIES_SQUIRTLE]    = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_WARTORTLE]   = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_BLASTOISE]   = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    ...
    [SPECIES_BUDEW]                        = { .size = MON_COORDS_SIZE(40, 56), .y_offset = 11 },
    [SPECIES_CHINGLING]                    = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 13 },
    ...
    [SPECIES_DUSKNOIR]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_ELECTIVIRE]                   = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    ...
    [SPECIES_MAGNEZONE]                    = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    ...
    [SPECIES_MIME_JR]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_MUNCHLAX]                     = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
    [SPECIES_PORYGON_Z]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_PROBOPASS]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    ...
    [SPECIES_ROSERADE]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_SYLVEON]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_TANGROWTH]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_TOGEKISS]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_WEAVILE]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_YANMEGA]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_ANNIHILAPE]                   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_FARIGIRAF]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  0 },
    [SPECIES_DUDUNSPARCE]                  = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  0 },
    [SPECIES_WYRDEER]                = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
