...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_VENUSAUR - 1]    = ANIM_H_STRETCH_FAR_SLOW,
    ...
    [SPECIES_KAKUNA - 1]      = ANIM_SWING_CONCAVE,
    [SPECIES_BEEDRILL - 1]    = ANIM_H_VIBRATE,
    [SPECIES_PIDGEY - 1]      = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_PIDGEOTTO - 1]   = ANIM_V_STRETCH,
    [SPECIES_PIDGEOT - 1]     = ANIM_FRONT_FLIP,
    [SPECIES_RATTATA - 1]     = ANIM_V_STRETCH,
    ...
    [SPECIES_SANDSHREW - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_SLOWBRO - 1]     = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    ...
    [SPECIES_DODRIO - 1]      = ANIM_GROW_VIBRATE,
    ...
    [SPECIES_CLOYSTER - 1]    = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    ...
    [SPECIES_KINGLER - 1]     = ANIM_GROW_VIBRATE,
